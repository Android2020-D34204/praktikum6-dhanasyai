...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonPindah = findViewById(R.id.btnGanti);
    ...
    public void notif() {
        ...
        builder.setContentText("Berhasil pindah ke activity ke dua");
        builder.setStyle(new NotificationCompat.BigTextStyle().bigText("Berhasil pindah ke activity ke dua"));
